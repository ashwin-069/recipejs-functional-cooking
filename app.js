...
const recipes = [
  ...
  },
  {
    ...
    time: 45,
    difficulty: "medium",
    description: "Tender chicken in a spiced sauce.",
    category: "curry"
  },
  {
    id: 3,
  ...
  },
  {
    ...
    time: 120,
    difficulty: "hard",
    description: "Beef wrapped in flaky pastry.",
    category: "meat"
  },
  {
    id: 6,
    ...
    time: 20,
    difficulty: "easy",
    description: "Quick stir-fried mixed vegetables.",
    category: "vegetarian"
  },
  {
    id: 7,
    ...
    time: 30,
    difficulty: "medium",
    description: "Thai noodles with tangy sauce.",
    category: "noodles"
  },
  {
    id: 8,
...
// Create HTML for ONE recipe card (pure)
...
// ------------------ Update Display ------------------
// Central controller function (VERY IMPORTANT FOR KALVIUM)
const updateDisplay = () => {
